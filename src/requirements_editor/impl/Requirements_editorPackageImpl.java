...
public class Requirements_editorPackageImpl extends EPackageImpl implements Requirements_editorPackage {
	 ...
	 * @generated
	 */
	public EOperation getRequirement__FindLeafNodes__Argument() {
	...
	public void createPackageContents() {
		...
		createEOperation(requirementEClass, REQUIREMENT___FIND_LEAF_NODES__ARGUMENT);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getRequirement__FindLeafNodes__Argument(), this.getRequirementArgument(), "findLeafNodes", 0, -1, IS_UNIQUE, !IS_ORDERED);
		addEParameter(op, this.getArgument(), "argument", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getDocumentRoot_Name(), ecorePackage.getEString(), "name", null, 0, 1, DocumentRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (requirementEClass, 
		   source, 
		   new String[] {
			 "constraints", "differentResponsible notItself"
		   });	
		addAnnotation
		  (categoryEClass, 
		   source, 
		...
		addAnnotation
		  (requirementEClass, 
		   ...
		   new String[] {
			 ...
			 "notItself", "self.dependencySource->select(oclIsTypeOf(Requires))->forAll(requires: Dependency | findLeafNodes(requires.oclAsType(Requires).argument)->forAll(ra: RequirementArgument | ra.requirement <> self))"
		   });	
		addAnnotation
		  (getRequirement__FindLeafNodes__Argument(), 
		   source, 
		   new String[] {

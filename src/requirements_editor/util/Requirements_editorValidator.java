...
public class Requirements_editorValidator extends EObjectValidator {
	...
	public boolean validateRequirement(Requirement requirement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateRequirement_notItself(requirement, diagnostics, context);
		return result;
	}
	...
	/**
	 * The cached validation expression for the notItself constraint of '<em>Requirement</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String REQUIREMENT__NOT_ITSELF__EEXPRESSION = "self.dependencySource->select(oclIsTypeOf(Requires))->forAll(requires: Dependency | findLeafNodes(requires.oclAsType(Requires).argument)->forAll(ra: RequirementArgument | ra.requirement <> self))";

	/**
	 * Validates the notItself constraint of '<em>Requirement</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateRequirement_notItself(Requirement requirement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(Requirements_editorPackage.Literals.REQUIREMENT,
				 requirement,
				 ...
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "notItself",
				 REQUIREMENT__NOT_ITSELF__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateQualityRequirement(QualityRequirement qualityRequirement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateRequirement_notItself(qualityRequirement, diagnostics, context);
		return result;
	}
	...
	public boolean validateFunctionalRequirement(FunctionalRequirement functionalRequirement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateRequirement_notItself(functionalRequirement, diagnostics, context);
		return result;
	}
	...
	public boolean validateRequires(Requires requires, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(requires, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(requires, diagnostics, context);
		if (result || diagnostics != null) result &= validateRequires_selfDependency(requires, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the selfDependency constraint of '<em>Requires</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String REQUIRES__SELF_DEPENDENCY__EEXPRESSION = "self.argument.oclAsSet()->closure(arg : Argument | \n" +
	...
	/**
	 * Validates the selfDependency constraint of '<em>Requires</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateRequires_selfDependency(Requires requires, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(Requirements_editorPackage.Literals.REQUIRES,
				 requires,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "selfDependency",
				 REQUIRES__SELF_DEPENDENCY__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
